...
if (tsvPath && fs.existsSync(tsvPath)) {
  ...
  processData(tsvText);
  console.log('\n✓ All monthly dashboard caches created successfully');
} else {
  console.log('Usage: node parse-monthly-data.mjs <path-to-tsv-file>');
  console.log('Example: node parse-monthly-data.mjs data/monthly-data.tsv');
}
